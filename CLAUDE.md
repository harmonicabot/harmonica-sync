...
- **Incremental updates** — Re-sync changed sessions (by `updated_at` or response count) instead of skipping already-synced ones.
- **Webhook trigger** — React to Harmonica webhooks instead of polling every 6 hours.
